...
const Project = props => {
  ...
  return (
    ...
    >
      ...
      <div
        className="project-description mt-4 mb-3 mt-md-5 mb-md-5 my-md-auto px-2 px-sm-4 px-xl-5"
        style={props.reverse ? { textAlign: "right" } : {}}
      >
        <h3>
          {props.title} <span className="date-section">/ {props.date}</span>
        </h3>
        {props.description.split("<br>").map(text => (
          <p
            className="text-justify-mobile"
            key={text}
        ...
        <ReactTooltip
          ...
          effect="solid"
          data-html={true}
          textColor={"rgba(251, 251, 251, 1.00)"}
          offset={{ top: -4, left: 0 }}
        />
        <div className="source-center-mobile">
          <span className={props.noSite ? "d-none" : ""}>
            <a
              href={props.site}
              className="p-0 clicky-effect link"
              target="_blank"
              rel="noopener noreferrer"
            >
              View site
          ...
          <a
            href={props.source}
            className={props.source ? "clicky-effect link" : "d-none"}
            target="_blank"
            rel="noopener noreferrer"
          >
            View source
          ...
          <span
            className={props.source ? "d-none" : "disabled-link no-select"}
            target="_blank"
            rel="noopener noreferrer"
          >
            Source private
